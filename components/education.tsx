      ...
      <section id="education" className="py-32 relative gradient-bg grid-bg">
        <div className="container mx-auto px-6 md:px-0 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">{t("education.subtitle")}</p>
          </motion.div>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1 space-y-4">
                    <div>
                      ...
                      <p className="text-lg text-muted-foreground font-medium">{t("education.level")}</p>
                    </div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">{t("education.description")}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
